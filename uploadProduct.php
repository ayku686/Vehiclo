<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO sproduct (sid, product, pcat, pinfo, price)
			   VALUES ('$sid', '$productName', '$productType', '$productInfo', '$productPrice')";
		...
		if(in_array($picActualExt, $allowed))
		{
			if($picError === 0)
			{
				...
				$sql = "UPDATE sproduct SET picStatus=1, pimage='$picNameNew' WHERE product='$productName';";
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<div class="row">
					  ...
					  <div class="col-sm-6">
						<input type="text" name="pname" id="pname" value="" placeholder="Vehicle Name/Model" style="background-color:white;color: black;" />
					  </div>
				</div>
				<br>
				<div>
					<textarea  name="pinfo" id="pinfo" rows="8"></textarea>
				</div>
			<br>
			<div class="row">
				<div class="col-sm-6">
