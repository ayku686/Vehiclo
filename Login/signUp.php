...
if($category == 1)
{
    ...
    $result = mysqli_query($conn, "SELECT * FROM Seller WHERE semail='$email'") or die($mysqli->error());
    ...
    {
    	$sql = "INSERT INTO Seller (sname, susername, spassword, shash, smobile, semail, saddress)
